...
void main() {
  ...
  const testProductDetail = Product(id: '1', name: 'Apple', description: 'A testing apple.', imageUrl: 'imageUrl', price: 10.99);
  ...
  test('should get current product from the repository', () async{
    ...
    //arrange
    when(
      mockProductRepository.getCurrentProduct(testProductId)
